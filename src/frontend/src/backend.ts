...
import type { ContactSubmission as _ContactSubmission, ServiceInterest as _ServiceInterest, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string, arg3: ServiceInterest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactForm(arg0, arg1, arg2, to_candid_ServiceInterest_n6(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "seo" in value ? ServiceInterest.seo : "workshop" in value ? ServiceInterest.workshop : "socialMediaManagement" in value ? ServiceInterest.socialMediaManagement : "googleAds" in value ? ServiceInterest.googleAds : "consulting" in value ? ServiceInterest.consulting : "paidAds" in value ? ServiceInterest.paidAds : value;
}
...
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceInterest): {
    ...
    return value == ServiceInterest.seo ? {
        seo: null
    } : value == ServiceInterest.workshop ? {
        workshop: null
    } : value == ServiceInterest.socialMediaManagement ? {
        socialMediaManagement: null
    } : value == ServiceInterest.googleAds ? {
        googleAds: null
    } : value == ServiceInterest.consulting ? {
        consulting: null
    } : value == ServiceInterest.paidAds ? {
        paidAds: null
    } : value;
}
